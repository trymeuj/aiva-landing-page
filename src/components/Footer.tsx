        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/contact" className="text-[#444444] text-lg hover:text-[#222222] transition-colors">Contact</Link></li>
            </ul>
          </div>
          
          <div>
            <h4 className="font-semibold text-xl mb-6 text-[#222222]">Resources</h4>
            <ul className="space-y-4">
              <li><Link href="/blog" className="text-[#444444] text-lg hover:text-[#222222] transition-colors">Blog</Link></li>
              <li><Link href="/documentation" className="text-[#444444] text-lg hover:text-[#222222] transition-colors">Documentation</Link></li>
              <li><Link href="/faq" className="text-[#444444] text-lg hover:text-[#222222] transition-colors">FAQ</Link></li>
            </ul>
          </div>
